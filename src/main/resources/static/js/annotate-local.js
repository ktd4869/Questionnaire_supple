...
function LoadFile() {
    ...
    for (var i2 = 1; i2 < ranNum + 1; i2++) {
        ...
        //修改为http
        // $("#" + articleid[i2 - 1] + "_txt").load("https://github.com/ktd4869/Questionnaire_v1.4/blob/master/" + articleid[i2 - 1] + "_txt.html");
		$("#" + articleid[i2 - 1] + "_txt").load("https://ktd4869.github.io/Questionnaire_v1.4/html_new_token/" + articleid[i2 - 1] + "_txt.html");
...
$(document).ready(function () {
    ...
    function loadtok() {
        ...
        $("[id^=tok]").popover({
            ...
            title: function () {
				...
				return "Select one difficulty level (1-10) or click 'It's not a term'";
            },
            html: true,
            trigger: "focus"
        });
    ...
    function addlabel(sentid, starttokid, endtokid, newclass) {
		...
		*/
		...
		newspans.push(newclass + "-" + start + "-" + end);
